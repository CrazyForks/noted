...
export const DEFAULT_THEMES = [
  ...
  },
  {
    ...
    isDarkTheme: false,
    background: '#eef5f8',
    backgroundFade: '#ddebf1',
    typeMain: '#172a33',
    typeSubtle: '#607783',
    typeSubtlePlus: '#317f9d',
    typeHighlight: '#cfe3eb',
    typeLight: '#829aa5',
    typeSuperlight: '#c7d8df',
    typeHyperLight: '#e6f0f4',
    typeReverse: '#ffffff',
    accent1Main: '#317f9d',
    accent1Secondary: '#256b86',
    accent1Tertiary: '#1f566c',
    accent2Main: '#5b6fb0',
    accent2Secondary: '#46588f',
    accent3Main: '#4b8a72',
    accent3Secondary: '#386f5a',
    accent4Main: '#bc8242',
    accent4Secondary: '#96642e',
    accent5Main: '#bd5f5f',
    accent5Secondary: '#984747',
    gridSuperlight: '#00000000',
    gridClear: '#00000000',
    gridBold: '#00000000',
    gridEnabled: false
  },
  {
    ...
    isDarkTheme: false,
    background: '#eef4ef',
    backgroundFade: '#e1eae4',
    typeMain: '#21302b',
    typeSubtle: '#60746b',
    typeSubtlePlus: '#3d8269',
    typeHighlight: '#d5e4da',
    typeLight: '#83958d',
    typeSuperlight: '#c8d8ce',
    typeHyperLight: '#e6eee8',
    typeReverse: '#ffffff',
    accent1Main: '#3d8269',
    accent1Secondary: '#316b56',
    accent1Tertiary: '#285644',
    accent2Main: '#6b6fa8',
    accent2Secondary: '#555989',
    accent3Main: '#7c8d52',
    accent3Secondary: '#62703f',
    accent4Main: '#b3844a',
    accent4Secondary: '#916836',
    accent5Main: '#bd6259',
    accent5Secondary: '#974940',
    gridSuperlight: '#00000000',
    gridClear: '#00000000',
    gridBold: '#00000000',
    gridEnabled: false
  },
  {
    ...
    isDarkTheme: true,
    background: '#16181a',
    backgroundFade: '#202428',
    typeMain: '#edf2f4',
    typeSubtle: '#9aa7ad',
    typeSubtlePlus: '#7cc7b2',
    typeHighlight: '#2c3338',
    typeLight: '#75838a',
    typeSuperlight: '#283036',
    typeHyperLight: '#1c2125',
    typeReverse: '#111416',
    accent1Main: '#7cc7b2',
    accent1Secondary: '#5aa895',
    accent1Tertiary: '#438877',
    accent2Main: '#91a7d8',
    accent2Secondary: '#7188bd',
    accent3Main: '#9fbd75',
    accent3Secondary: '#809d59',
    accent4Main: '#d5a15f',
    accent4Secondary: '#b17e43',
    accent5Main: '#dc7470',
    accent5Secondary: '#b45754',
    gridSuperlight: '#00000000',
    gridClear: '#00000000',
    gridBold: '#00000000',
    gridEnabled: false
